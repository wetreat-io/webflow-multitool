...
const gptSystemPrompt = `
    ...
    Using the user prompt, rewrite the page with the new theme.
    Try to match or exceed the original length of each string node.
    Don't include anything about "Learn more" or "Learn how", unless otherwise specified by the user prompt.
    
    Important:
    - Do not add or remove any nodes.
